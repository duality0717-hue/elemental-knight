...
- Proyecto Supabase exclusivo creado y conectado: Elemental Knight, región São Paulo. Guardado y aislamiento entre cuentas verificados en la base real. Pendiente configurar correo SMTP y comprobar registro/login completos antes de publicar las cuentas para todos los jugadores. No se modificaron los datos de Ruta Cero.
